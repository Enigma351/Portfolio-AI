...
export default function ContactApp() {
  const contacts = [
    { icon: <Mail />, label: 'Email', value: 'senpartho15@gmail.com', href: 'mailto:senpartho15@gmail.com' },
    { icon: <Phone />, label: 'Phone', value: '+91 9101535282', href: 'tel:+919101535282' },
    { icon: <Link />, label: 'LinkedIn', value: 'linkedin.com/in/partha-sen', href: 'https://www.linkedin.com/in/partha-sen' },
    { icon: <GithubIcon />, label: 'GitHub', value: 'github.com/Enigma351', href: 'https://github.com/Enigma351' },
    { icon: <InstagramIcon />, label: 'Instagram', value: '@partha.sen', href: 'https://instagram.com/' }
  ];
  ...
  return (
    <div className="flex flex-col bg-slate-900 p-6 md:p-8 items-center text-slate-200 min-h-full h-full w-full">
      ...
      <p className="text-neon-purple font-mono font-semibold mb-8 text-sm text-center">Open to Opportunities</p>
